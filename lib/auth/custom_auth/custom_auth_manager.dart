...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    unicarMapsAuthUserSubject.add(
      UnicarMapsAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<UnicarMapsAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  UnicarMapsAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = UnicarMapsAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    unicarMapsAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
UnicarMapsAuthUser? currentUser;
