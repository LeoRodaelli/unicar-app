  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final informacoesCaronaMotoristaBuscarDadosDeCaronaResponse =
            snapshot.data!;
                    ...
                    children: [
                      ...
                      wrapWithModel(
                        ...
                        child: AvailableSeatsWidget(
                          available: RideStruct.fromMap(
                                  informacoesCaronaMotoristaBuscarDadosDeCaronaResponse
                                      .jsonBody)
                              .passengers
                              .length,
                          total: RideStruct.fromMap(
                                  informacoesCaronaMotoristaBuscarDadosDeCaronaResponse
                                      .jsonBody)
                              .maximumSeats,
                        ),
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, passengersIndex) {
                          ...
                          return PassegerWidget(
                            key: Key(
                                'Keyhm0_${passengersIndex}_of_${passengers.length}'),
