...
import 'edicao_perfil_model.dart';
export 'edicao_perfil_model.dart';

class EdicaoPerfilWidget extends StatefulWidget {
  const EdicaoPerfilWidget({Key? key}) : super(key: key);

  @override
  _EdicaoPerfilWidgetState createState() => _EdicaoPerfilWidgetState();
}

class _EdicaoPerfilWidgetState extends State<EdicaoPerfilWidget> {
  late EdicaoPerfilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EdicaoPerfilModel());
