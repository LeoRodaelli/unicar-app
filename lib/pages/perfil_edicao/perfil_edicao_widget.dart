  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<PerfilRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PerfilRecord> perfilEdicaoPerfilRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final perfilEdicaoPerfilRecord = perfilEdicaoPerfilRecordList.isNotEmpty
            ? perfilEdicaoPerfilRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).secondaryBackground,
                            ...
                            children: [
                              Stack(
                                children: [
                                  Align(
                                    alignment:
                                        AlignmentDirectional(-0.04, 0.02),
                                    child: Icon(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await currentUserReference!
                          ...
                          email: _model.universidadeController.text,
